...
var NotStreamableError = function(message) {
    this.name = "NotStreamableError";
    this.message = message || "The media retrieved is not streamable.";
}
NotStreamableError.prototype = new Error();
NotStreamableError.prototype.constructor = NotStreamableError;
...
StreamApi.prototype = {
    ...
    request: function(params) {
        var api = this, callback, options, url;
        callback = api.getOne;
...
SearchApi.prototype = {
    ...
    search: function(params) {
        ...
        return Q.nfcall(request, options).then(function(args) {
            var body = args[1];
            var results = callback(body);
            if (!results) {
                throw new Error('There was a problem getting search results.');
