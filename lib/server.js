...
var getApplication = function() {
	...
	var testScripts = ['js/q.js', 'js/mocha.js', 'js/chai.js', 'js/chai-as-promised.js'];
	var appScripts = [], reject = false;
	...
	app.get(/^\/([1-9][0-9]*)?$/, function(req, res) {
		var additionalJS = 'js/' + app.get('env');
		res.render('playlist', {environment: additionalJS, js: appScripts, reject: reject});
	});
