...
"none"==o.display?(h.css({display:"block",visibility:"hidden"}),o):{}},getElementDimensions:function(h){var p={},o=p.css={},t={},F,L,A=f.layout.cssNum,y=h.offset();p.offsetLeft=y.left;p.offsetTop=y.top;f.each("Left,Right,Top,Bottom".split(","),function(y,A){F=o["border"+A]=f.layout.borderWidth(h,A);L=o["padding"+A]=f.layout.cssNum(h,"padding"+A);t[A]=F+L;p["inset"+A]=L});p.offsetWidth=h.innerWidth();p.offsetHeight=h.innerHeight();p.outerWidth=h.outerWidth();p.outerHeight=h.outerHeight();p.innerWidth=
Math.max(0,p.outerWidth-t.Left-t.Right);p.innerHeight=Math.max(0,p.outerHeight-t.Top-t.Bottom);o.width=h.width();o.height=h.height();o.top=A(h,"top",!0);o.bottom=A(h,"bottom",!0);o.left=A(h,"left",!0);o.right=A(h,"right",!0);return p},getElementCSS:function(f,p){var o={},t=f[0].style,F=p.split(","),L="Top,Bottom,Left,Right".split(","),A="Color,Style,Width".split(","),y,T,ca,U,V,Z;for(U=0;U<F.length;U++)if(y=F[U],y.match(/(border|padding|margin)$/))for(V=0;4>V;V++)if(T=L[V],"border"==y)for(Z=0;3>Z;Z++)ca=
A[Z],o[y+T+ca]=t[y+T+ca];else o[y+T]=t[y+T];else o[y]=t[y];return o},cssWidth:function(h,p){var o=f.layout.borderWidth,t=f.layout.cssNum;if(0>=p)return 0;if(!f.layout.browser.boxModel)return p;o=p-o(h,"Left")-o(h,"Right")-t(h,"paddingLeft")-t(h,"paddingRight");return Math.max(0,o)},cssHeight:function(h,p){var o=f.layout.borderWidth,t=f.layout.cssNum;if(0>=p)return 0;if(!f.layout.browser.boxModel)return p;o=p-o(h,"Top")-o(h,"Bottom")-t(h,"paddingTop")-t(h,"paddingBottom");return Math.max(0,o)},cssNum:function(h,
...
c[0]==a)return Aa(decodeURIComponent(c[1]));return""}function na(a,b){var c=f.extend({},n.cookie,b||{}),e=c.name||n.name||"Layout",d="",j="",g=!1;c.expires.toUTCString?j=c.expires:"number"==typeof c.expires&&(j=new Date,0<c.expires?j.setDate(j.getDate()+c.expires):(j.setYear(1970),g=!0));j&&(d+=";expires="+j.toUTCString());c.path&&(d+=";path="+c.path);c.domain&&(d+=";domain="+c.domain);c.secure&&(d+=";secure");g?(l.cookie={},document.cookie=e+"="+d):(l.cookie=oa(a||c.keys),document.cookie=e+"="+encodeURIComponent(Ba(l.cookie))+
d);return f.extend({},l.cookie)}function Ca(a){if(a=Z(a))l.cookie=f.extend({},a),Da(a);return a}function Da(a,b){a=Ea(a);f.extend(!0,n,a);if(l.initialized){var c,e,d,j,g=!b;f.each(k.allPanes.split(","),function(b,f){c=a[f];if("object"==typeof c)e=c.size,j=c.initClosed,d=c.initHidden,(0<e||"auto"==e)&&$(f,e),!0===d?ka(f,g):!1===j?M(f,!1,g):!0===j?H(f,!1,g):!1===d&&ha(f,!1,g)})}}function oa(a){var b={},c={isClosed:"initClosed",isHidden:"initHidden"},e,d,j;if(!a)a=n.cookie.keys;f.isArray(a)&&(a=a.join(","));
for(var a=a.replace(/__/g,".").split(","),g=0,i=a.length;g<i;g++)e=a[g].split("."),d=e[0],e=e[1],0>k.allPanes.indexOf(d)||(j=l[d][e],void 0!=j&&("isClosed"==e&&l[d].isSliding&&(j=!0),(b[d]||(b[d]={}))[c[e]?c[e]:e]=j));return b}function Ba(a){function b(a){var e=[],d=0,f,g,i;for(f in a)g=a[f],i=typeof g,"string"==i?g='"'+g+'"':"object"==i&&(g=b(g)),e[d++]='"'+f+'":'+g;return"{"+e.join(",")+"}"}return b(a)}function Aa(a){try{return window.eval("("+a+")")||{}}catch(b){return{}}}var C=f.layout.language,
...
east:{side:"Right",sizeType:"Width",dir:"vert",cssReq:{left:"auto",right:0,top:"auto",bottom:"auto",height:"auto"},pins:[]},west:{side:"Left",sizeType:"Width",dir:"vert",cssReq:{left:0,right:"auto",top:"auto",bottom:"auto",height:"auto"},pins:[]},center:{dir:"center",cssReq:{left:"auto",right:"auto",top:"auto",bottom:"auto",height:"auto",width:"auto"}}},E={data:{},set:function(a,b,c){E.clear(a);E.data[a]=setTimeout(b,c)},clear:function(a){var b=E.data;b[a]&&(clearTimeout(b[a]),delete b[a])}},G=function(a){try{return"string"==
typeof a||"object"==typeof a&&null!==a.constructor.toString().match(/string/i)}catch(b){return!1}},z=function(a,b){return Math.max(a,b)},Ea=function(a){var b,c={cookie:{},defaults:{fxSettings:{}},north:{fxSettings:{}},south:{fxSettings:{}},east:{fxSettings:{}},west:{fxSettings:{}},center:{fxSettings:{}}},a=a||{};a.effects||a.cookie||a.defaults||a.north||a.south||a.west||a.east||a.center?c=f.extend(!0,c,a):f.each(a,function(a,d){b=a.split("__");if(!b[1]||c[b[0]])c[b[1]?b[0]:"defaults"][b[1]?b[1]:b[0]]=
d});return c},Fa=function(a,b,c){function e(j){var g=k[j];g.doCallback?(d.push(j),j=g.callback.split(",")[1],j!=b&&0<=!f.inArray(j,d)&&e(j)):(g.doCallback=!0,g.callback=a+","+b+","+(c?1:0))}var d=[];f.each(k.borderPanes.split(","),function(a,b){if(k[b].isMoving)return e(b),!1})},Ga=function(a){a=k[a];k.isLayoutBusy=!1;delete a.isMoving;if(a.doCallback&&a.callback){a.doCallback=!1;var b=a.callback.split(","),c=0<b[2]?!0:!1;"open"==b[0]?M(b[1],c):"close"==b[0]&&H(b[1],c);if(!a.doCallback)a.callback=
null}},v=function(a,b){if(b){var c;try{if("function"==typeof b)c=b;else if(G(b))if(b.match(/,/)){var e=b.split(",");c=eval(e[0]);if("function"==typeof c&&1<e.length)return c(e[1])}else c=eval(b);else return;if("function"==typeof c)return a&&r[a]?c(a,r[a],l[a],n[a],n.name):c(ea,l,n,n.name)}catch(d){}}},Ha=function(a){if(!f.layout.browser.mozilla){var b=r[a];"IFRAME"==l[a].tagName?b.css(k.hidden).css(k.visible):b.find("IFRAME").css(k.hidden).css(k.visible)}},J=function(a,b){var c=G(a),e=c?r[a]:f(a);
if(!e.length)return 0;isNaN(b)&&(b=c?R(a):e.outerWidth());return f.layout.cssWidth(e,b)},K=function(a,b){var c=G(a),e=c?r[a]:f(a);if(!e.length)return 0;isNaN(b)&&(b=c?R(a):e.outerHeight());return f.layout.cssHeight(e,b)},la=function(a){var b=k[a].dir,a={minWidth:1001-J(a,1E3),minHeight:1001-K(a,1E3)};if("horz"==b)a.minSize=a.minHeight;if("vert"==b)a.minSize=a.minWidth;return a},Ra=function(a,b,c){var e=a;G(a)?e=r[a]:a.jquery||(e=f(a));a=K(e,b);e.css({height:a,visibility:"visible"});0<a&&0<e.innerWidth()?
c&&e.data("autoHidden")&&(e.show().data("autoHidden",!1),f.layout.browser.mozilla||e.css(k.hidden).css(k.visible)):c&&!e.data("autoHidden")&&e.hide().data("autoHidden",!0)},W=function(a,b,c){if(!c)c=k[a].dir;G(b)&&b.match(/%/)&&(b=parseInt(b,10)/100);if(0===b)return 0;if(1<=b)return parseInt(b,10);if(0<b){var a=n,e;"horz"==c?e=u.innerHeight-(r.north?a.north.spacing_open:0)-(r.south?a.south.spacing_open:0):"vert"==c&&(e=u.innerWidth-(r.west?a.west.spacing_open:0)-(r.east?a.east.spacing_open:0));return Math.floor(e*
b)}if("center"==a)return 0;e=r[a];var c="horz"==c?"height":"width",a=f.layout.showInvisibly(e),d=e.css(c);e.css(c,"auto");b="height"==c?e.outerHeight():e.outerWidth();e.css(c,d).css(a);return b},R=function(a,b){var c=r[a],e=n[a],d=l[a],f=b?e.spacing_open:0,e=b?e.spacing_closed:0;return!c||d.isHidden?0:d.isClosed||d.isSliding&&b?e:"horz"==k[a].dir?c.outerHeight()+f:c.outerWidth()+f},N=function(a,b){if(w()){var c=n[a],e=l[a],d=k[a],f=d.dir;d.side.toLowerCase();d.sizeType.toLowerCase();var d=void 0!=
...
n[a].paneSelector;if("#"===a.substr(0,1))return q.find(a).eq(0);var b=q.children(a).eq(0);return b.length?b:q.children("form:first").children(a).eq(0)},Sa=function(){f.each(k.allPanes.split(","),function(a,b){Na(b,!0)});ua();f.each(k.borderPanes.split(","),function(a,b){r[b]&&l[b].isVisible&&(N(b),X(b))});Y("center");setTimeout(function(){f.each(k.allPanes.split(","),function(a,b){var c=n[b];r[b]&&l[b].isVisible&&(c.triggerEventsOnLoad&&v(b,c.onresize_end||c.onresize),aa(b))})},50);n.showErrorMessages&&
2>q.innerHeight()&&alert(C.errContainerHeight.replace(/CONTAINER/,u.ref))},Na=function(a,b){if(b||w()){var c=n[a],e=l[a],d=k[a],j=d.dir,g="center"==a,i={},m=r[a],h;m?va(a):P[a]=!1;m=r[a]=Ja(a);if(m.length){m.data("layoutCSS")||m.data("layoutCSS",f.layout.getElementCSS(m,"position,top,left,bottom,right,width,height,overflow,zIndex,display,backgroundColor,padding,margin,border"));m.data("parentLayout",ea).data("layoutRole","pane").data("layoutEdge",a).css(d.cssReq).css("zIndex",k.zIndex.pane_normal).css(c.applyDemoStyles?
d.cssDemo:{}).addClass(c.paneClass+" "+c.paneClass+"-"+a).bind("mouseenter."+B,ra).bind("mouseleave."+B,S);Oa(a,!1);if(!g)h=e.size=W(a,c.size),d=W(a,c.minSize)||1,g=W(a,c.maxSize)||1E5,0<h&&(h=z(Math.min(h,g),d)),e.isClosed=!1,e.isSliding=!1,e.isResizing=!1,e.isHidden=!1;e.tagName=m[0].tagName;e.edge=a;e.noRoom=!1;e.isVisible=!0;switch(a){case "north":i.top=u.insetTop;i.left=u.insetLeft;i.right=u.insetRight;break;case "south":i.bottom=u.insetBottom;i.left=u.insetLeft;i.right=u.insetRight;break;case "west":i.left=
u.insetLeft;break;case "east":i.right=u.insetRight}if("horz"==j)i.height=z(1,K(a,h));else if("vert"==j)i.width=z(1,J(a,h));m.css(i);"horz"!=j&&Y(a,!0);c.initClosed&&c.closable&&!c.initHidden?H(a,!0,!0):c.initHidden||c.initClosed?ka(a):e.noRoom||m.css("display","block");m.css("visibility","visible");c.showOverflowOnHover&&m.hover(o,t);l.initialized&&(ua(a),Ma(a),ga(),e.isVisible&&(c.triggerEventsOnLoad&&v(a,c.onresize_end||c.onresize),aa(a)))}else r[a]=!1}},ua=function(a){if(!a||"all"==a)a=k.borderPanes;
...
c.applyDemoStyles&&(j.css(k.content.cssDemo),d.css(k.content.cssDemoPane)),l[a].content={},!1!==b&&fa(a)):P[a]=!1}},Wa=function(){var a;f.each("toggle,open,close,pin,toggle-slide,open-slide".split(","),function(b,c){f.each(k.borderPanes.split(","),function(b,d){f(".ui-layout-button-"+c+"-"+d).each(function(){a=f(this).data("layoutName")||f(this).attr("layoutName");(void 0==a||a==n.name)&&L(this,c,d)})})})},Va=function(a){var b="function"==typeof f.fn.draggable,c;if(!a||"all"==a)a=k.borderPanes;f.each(a.split(","),
function(a,d){var j=n[d],g=l[d],i=k[d],m="horz"==i.dir?"top":"left",h,I;if(!b||!r[d]||!j.resizable)return j.resizable=!1,!0;var o=x[d],p=j.resizerClass,t=p+"-drag",w=p+"-"+d+"-drag",z=p+"-dragging",A=p+"-"+d+"-dragging",y=p+"-dragging-limit",C=p+"-"+d+"-dragging-limit",D=!1;g.isClosed||o.attr("title",j.resizerTip).css("cursor",j.resizerCursor);o.bind("mouseenter."+B,Ia).bind("mouseleave."+B,sa);o.draggable({containment:q[0],axis:"horz"==i.dir?"y":"x",delay:0,distance:1,helper:"clone",opacity:j.resizerDragOpacity,
addClasses:!1,zIndex:k.zIndex.resizer_drag,start:function(){j=n[d];g=l[d];I=j.resizeWhileDragging;if(!1===v(d,j.ondrag_start))return!1;k.isLayoutBusy=!0;g.isResizing=!0;E.clear(d+"_closeSlider");N(d);h=g.resizerPosition;o.addClass(t+" "+w);D=!1;c=f(!0===j.maskIframesOnResize?"iframe":j.maskIframesOnResize).filter(":visible");var a,b=0;c.each(function(){a="ui-layout-mask-"+ ++b;f(this).data("layoutMaskID",a);f('<div id="'+a+'" class="ui-layout-mask ui-layout-mask-'+d+'"/>').css({background:"#fff",
...
" "+C),window.defaultStatus="Panel has reached its "+(0<c&&d.match(/north|west/)||0>c&&d.match(/south|east/)?"maximum":"minimum")+" size"):(b.helper.removeClass(y+" "+C),window.defaultStatus="");I&&F(a,b,d)},stop:function(a,b){f("body").enableSelection();window.defaultStatus="";o.removeClass(t+" "+w);g.isResizing=!1;k.isLayoutBusy=!1;F(a,b,d,!0)}});var F=function(a,b,d,e){var a=b.position,b=k[d],g;switch(d){case "north":g=a.top;break;case "west":g=a.left;break;case "south":g=u.offsetHeight-a.top-
...
j.length&&j.remove();r[a]=P[a]=x[a]=D[a]=!1;c||(ga(),l[a]={})}},ka=function(a,b){if(w()){var c=n[a],e=l[a],d=r[a],f=x[a];if(d&&!e.isHidden&&!(l.initialized&&!1===v(a,c.onhide_start)))if(e.isSliding=!1,f&&f.hide(),!l.initialized||e.isClosed){if(e.isClosed=!0,e.isHidden=!0,e.isVisible=!1,d.hide(),Y("horz"==k[a].dir?"all":"center"),l.initialized||c.triggerEventsOnLoad)v(a,c.onhide_end||c.onhide)}else e.isHiding=!0,H(a,!1,b)}},ha=function(a,b,c,e){if(w()){var d=l[a];if(r[a]&&d.isHidden&&!1!==v(a,n[a].onshow_start))d.isSliding=
!1,d.isShowing=!0,!1===b?H(a,!0):M(a,!1,c,e)}},da=function(a,b){if(w()){G(a)||(a.stopImmediatePropagation(),a=f(this).data("layoutEdge"));var c=l[G(a)?f.trim(a):void 0==a||null==a?"":a];c.isHidden?ha(a):c.isClosed?M(a,!!b):H(a)}},Xa=function(a){var b=l[a];r[a].hide();b.isClosed=!0;b.isVisible=!1},H=function(a,b,c,e){function d(){if(i.isClosed){ba(a,!0);var b=k.altSide[a];l[b].noRoom&&(N(b),X(b));if(!e&&(l.initialized||g.triggerEventsOnLoad))m||v(a,g.onclose_end||g.onclose),m&&v(a,g.onshow_end||g.onshow),
h&&v(a,g.onhide_end||g.onhide)}Ga(a)}if(!l.initialized&&r[a])Xa(a);else if(w()){var f=r[a],g=n[a],i=l[a],c=!c&&!i.isClosed&&"none"!=g.fxName_close,m=i.isShowing,h=i.isHiding;delete i.isShowing;delete i.isHiding;if(f&&(g.closable||m||h)&&(b||!i.isClosed||m))if(k.isLayoutBusy)Fa("close",a,b);else if(m||!1!==v(a,g.onclose_start)){k[a].isMoving=!0;k.isLayoutBusy=!0;i.isClosed=!0;i.isVisible=!1;if(h)i.isHidden=!0;else if(m)i.isHidden=!1;i.isSliding?ja(a,!1):Y("horz"==k[a].dir?"all":"center",!1);xa(a);
...
Qa=function(a){function b(){d.isClosed?k[e].isMoving||M(e,!0):ja(e,!0)}if(w()){var c=G(a)?null:a,e=c?f(this).data("layoutEdge"):a,d=l[e],a=n[e].slideDelay_open;c&&c.stopImmediatePropagation();d.isClosed&&c&&"mouseenter"==c.type&&0<a?E.set(e+"_openSlider",b,a):b()}},za=function(a){function b(){d.isClosed?ja(e,!1):k[e].isMoving||H(e)}if(w()){var c=G(a)?null:a,e=c?f(this).data("layoutEdge"):a,a=n[e],d=l[e],j=k[e].isMoving?1E3:300;if(!d.isClosed&&!d.isResizing)if("click"==a.slideTrigger_close)b();else if(!a.preventQuickSlideClose||
!k.isLayoutBusy)if(!a.preventPrematureSlideClose||!c||!f.layout.isMouseOverElem(c,r[e]))c?E.set(e+"_closeSlider",b,z(a.slideDelay_close,j)):b()}},ma=function(a,b){var c=r[a];if(b)c.css({zIndex:k.zIndex.pane_animate}),"south"==a?c.css({top:u.insetTop+u.innerHeight-c.outerHeight()}):"east"==a&&c.css({left:u.insetLeft+u.innerWidth-c.outerWidth()});else{c.css({zIndex:l[a].isSliding?k.zIndex.pane_sliding:k.zIndex.pane_normal});"south"==a?c.css({top:"auto"}):"east"==a&&c.css({left:"auto"});var e=n[a];f.layout.browser.msie&&
e.fxOpacityFix&&"slide"!=e.fxName_open&&c.css("filter")&&1==c.css("opacity")&&c[0].style.removeAttribute("filter")}},ba=function(a,b){var c=n[a],e=x[a],d=c.slideTrigger_open.toLowerCase();if(e&&(!b||c.slidable)){if(d.match(/mouseover/))d=c.slideTrigger_open="mouseenter";else if(!d.match(/click|dblclick|mouseenter/))d=c.slideTrigger_open="click";e[b?"bind":"unbind"](d+"."+B,Qa).css("cursor",b?c.sliderCursor:"default").attr("title",b?c.sliderTip:"")}},ja=function(a,b){function c(b){E.clear(a+"_closeSlider");
...
"default"),h.attr("title",b?e.togglerTip_open:"")):E.clear(a+"_closeSlider")},X=function(a,b,c,e){var b=n[a],d=l[a],j=k[a],g=r[a],i=x[a],m="vert"==j.dir,h=!1;if("center"==a||m&&d.noVerticalRoom)if((h=0<d.maxHeight)&&d.noRoom){g.show();i&&i.show();d.isVisible=!0;d.noRoom=!1;if(m)d.noVerticalRoom=!1;Ha(a)}else if(!h&&!d.noRoom)g.hide(),i&&i.hide(),d.isVisible=!1,d.noRoom=!0;if("center"!=a)if(d.minSize<=d.maxSize){if(d.size>d.maxSize?$(a,d.maxSize,c,e):d.size<d.minSize?$(a,d.minSize,c,e):i&&g.is(":visible")&&
(c=j.side.toLowerCase(),e=d.size+u["inset"+j.side],f.layout.cssNum(i,c)!=e&&i.css(c,e)),d.noRoom)d.wasOpen&&b.closable?b.autoReopen?M(a,!1,!0,!0):d.noRoom=!1:ha(a,d.wasOpen,!0,!0)}else if(!d.noRoom)d.noRoom=!0,d.wasOpen=!d.isClosed&&!d.isSliding,d.isClosed||(b.closable?H(a,!0,!0):ka(a,!0))},ya=function(a,b,c){if(w()){var e=n[a],d=e.resizeWhileDragging&&!k.isLayoutBusy;e.autoResize=!1;$(a,b,c,d)}},$=function(a,b,c,e){if(w()){var d=n[a],j=l[a],g=r[a],i=x[a],m=k[a].side.toLowerCase(),h=k[a].sizeType.toLowerCase(),
...
b<p&&l[a].noRoom&&(N(a),X(a,!1,c))}},Y=function(a,b,c){if(!a||"all"==a)a="east,west,center";f.each(a.split(","),function(a,d){if(r[d]){var j=n[d],g=l[d],i=r[d],m=!0,h={},m={top:R("north",!0),bottom:R("south",!0),left:R("west",!0),right:R("east",!0),width:0,height:0};m.width=u.innerWidth-m.left-m.right;m.height=u.innerHeight-m.bottom-m.top;m.top+=u.insetTop;m.bottom+=u.insetBottom;m.left+=u.insetLeft;m.right+=u.insetRight;f.extend(g,O(i));if("center"==d){if(!c&&g.isVisible&&m.width==g.outerWidth&&
...
f.extend(g,O(i),la(d));if(!c&&!g.noVerticalRoom&&m.height==g.outerHeight)return!0;h.top=m.top;h.bottom=m.bottom;h.height=K(d,m.height);g.maxHeight=z(0,h.height);m=0<g.maxHeight;if(!m)g.noVerticalRoom=!0}m?(!b&&l.initialized&&v(d,j.onresize_start),i.css(h),g.noRoom&&!g.isClosed&&!g.isHidden&&X(d),g.isVisible&&(f.extend(g,O(i)),l.initialized&&fa(d))):!g.noRoom&&g.isVisible&&X(d);if(!g.isVisible)return!0;if("center"==d)g=f.layout.browser,g=g.isIE6||g.msie&&!g.boxModel,r.north&&(g||"IFRAME"==l.north.tagName)&&
r.north.css("width",J(r.north,u.innerWidth)),r.south&&(g||"IFRAME"==l.south.tagName)&&r.south.css("width",J(r.south,u.innerWidth));!b&&l.initialized&&(v(d,j.onresize_end||j.onresize),aa(d))}})},ga=function(){if(l.initialized){if(q.is(":visible:")&&(f.extend(l.container,O(q)),u.outerHeight)){if(!1===v(null,n.onresizeall_start))return!1;var a,b,c;f.each(["south","north","east","west"],function(a,d){r[d]&&(c=l[d],b=n[d],b.autoResize&&c.size!=b.size?$(d,b.size,!0,!0):(N(d),X(d,!1,!0,!0)))});Y("all",!0,
!0);ia("all");b=n;f.each(k.allPanes.split(","),function(c,d){if((a=r[d])&&l[d].isVisible)v(d,b[d].onresize_end||b[d].onresize),aa(d)});v(null,b.onresizeall_end||b.onresizeall)}}else ta()},aa=function(a){var b=r[a],c=P[a];n[a].resizeNestedLayout&&(b.data("layoutContainer")?b.layout().resizeAll():c&&c.data("layoutContainer")&&c.layout().resizeAll())},fa=function(a,b){if(w()){if(!a||"all"==a)a=k.allPanes;f.each(a.split(","),function(a,e){function d(a){return z(o.css.paddingBottom,parseInt(a.css("marginBottom"),
10)||0)}function f(){var a=n[e].contentIgnoreSelector,a=i.nextAll().not(a||":lt(0)"),b=a.filter(":visible"),c=b.filter(":last");p={top:i[0].offsetTop,height:i.outerHeight(),numFooters:a.length,hiddenFooters:a.length-b.length,spaceBelow:0};p.spaceAbove=p.top;p.bottom=p.top+p.height;p.spaceBelow=c.length?c[0].offsetTop+c.outerHeight()-p.bottom+d(c):d(i)}var g=r[e],i=P[e],h=n[e],o=l[e],p=o.content;if(!g||!i||!g.is(":visible"))return!0;if(!1!==v(null,h.onsizecontent_start)){if(!k.isLayoutBusy||void 0==
p.top||b||h.resizeContentWhileDragging)f(),0<p.hiddenFooters&&"hidden"==g.css("overflow")&&(g.css("overflow","visible"),f(),g.css("overflow","hidden"));g=o.innerHeight-(p.spaceAbove-o.css.paddingTop)-(p.spaceBelow-o.css.paddingBottom);if(!i.is(":visible")||p.height!=g)Ra(i,g,!0),p.height=g;l.initialized&&(v(e,h.onsizecontent_end||h.onsizecontent),aa(e))}})}},ia=function(a){if(!a||"all"==a)a=k.borderPanes;f.each(a.split(","),function(a,c){var e=n[c],d=l[c],h=r[c],g=x[c],i=D[c],m;if(h&&g){var p=k[c].dir,
o=d.isClosed?"_closed":"_open",q=e["spacing"+o],t=e["togglerAlign"+o],o=e["togglerLength"+o],v;if(0==q)g.hide();else{!d.noRoom&&!d.isHidden&&g.show();"horz"==p?(v=h.outerWidth(),d.resizerLength=v,g.css({width:z(1,J(g,v)),height:z(0,K(g,q)),left:f.layout.cssNum(h,"left")})):(v=h.outerHeight(),d.resizerLength=v,g.css({height:z(1,K(g,v)),width:z(0,J(g,q)),top:u.insetTop+R("north",!0)}));S(e,g);if(i){if(0==o||d.isSliding&&e.hideTogglerOnSlide){i.hide();return}i.show();if(!(0<o)||"100%"==o||o>v)o=v,t=
0;else if(G(t))switch(t){case "top":case "left":t=0;break;case "bottom":case "right":t=v-o;break;default:t=Math.floor((v-o)/2)}else h=parseInt(t,10),t=0<=t?h:v-o+h;if("horz"==p){var w=J(i,o);i.css({width:z(0,w),height:z(1,K(i,q)),left:t,top:0});i.children(".content").each(function(){m=f(this);m.css("marginLeft",Math.floor((w-m.outerWidth())/2))})}else{var y=K(i,o);i.css({height:z(0,y),width:z(1,J(i,q)),top:t,left:0});i.children(".content").each(function(){m=f(this);m.css("marginTop",Math.floor((y-
...
if(!q.data("layoutRole")&&(!g||!g.match(/fixed|absolute|relative/)))d.position="relative";q.css(d);h&&(f.extend(u,O(q)),c.showErrorMessages&&2>u.innerHeight&&alert(C.errContainerHeight.replace(/CONTAINER/,u.ref)))}}catch(i){}Ma();a.autoBindCustomButtons&&Wa();f(window).bind("unload."+B,La);a.initPanes&&ta();delete l.creatingLayout;return l.initialized}()?null:ea}})(jQuery);